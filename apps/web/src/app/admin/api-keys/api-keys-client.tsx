...
type APIKeyRecord = {
  ...
  billing_group: { id: string; code: string; display_name: string; kind?: "standard" | "composite"; multiplier_bps: number; effective_multiplier_bps?: number };
  name: string;
  key_prefix: string;
