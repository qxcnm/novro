...
type APIKeyRecord = { id: string; billing_group_id: string; billing_group: { id: string; code: string; display_name: string; multiplier_bps: number; effective_multiplier_bps?: number }; name: string; key_prefix: string; can_copy_secret: boolean; status: "active" | "revoked"; last_used_at: string | null; created_at: string; revoked_at: string | null };
