...
func (_c *WalletCreate) SetBalanceMicros(v int64) *WalletCreate {
	_c.mutation.SetBalanceMicros(v)
	return _c
}

// SetNillableBalanceMicros sets the "balance_micros" field if the given value is not nil.
func (_c *WalletCreate) SetNillableBalanceMicros(v *int64) *WalletCreate {
	if v != nil {
...
func (_c *WalletCreate) AddEntryIDs(ids ...uuid.UUID) *WalletCreate {
	_c.mutation.AddEntryIDs(ids...)
	return _c
}

// AddEntries adds the "entries" edges to the WalletEntry entity.
func (_c *WalletCreate) AddEntries(v ...*WalletEntry) *WalletCreate {
